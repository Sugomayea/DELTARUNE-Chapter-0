...
if (menu = 1) {
	...
	if (selected = 0 and global.selectButtonPressed) {
		...
		var instantiatedFade = instance_create_depth(0, 0, -9999, obj_titleFadeContinue)
...
if (menu = 5) {
	if (timer3 <= 0) {
		if ((selected = 0 and global.selectButtonPressed) or keyboard_check_pressed(global.cancelButton)) {
			audio_play_sound(sfx_select, 10, false)
			menu = 1
			selected = 0
		}
...
//controls
if (global.downButtonPressed1 and menu == 1 and selected == 1) {
	selected = 4
	audio_play_sound(sfx_move, 10, false)
} else if (global.downButtonPressed1 and menu != 5) {
	selected++
	audio_play_sound(sfx_move, 10, false)
}

if (global.upButtonPressed1 and menu != 5) {
	selected--
	audio_play_sound(sfx_move, 10, false)
}
...
if (global.rightButtonPressed1 and menu = 5) {
	selected++
	audio_play_sound(sfx_move, 10, false)
}

if (global.leftButtonPressed1 and menu = 5) {
	selected--
	audio_play_sound(sfx_move, 10, false)
}
...
if (global.leftButtonPressed1 and menu = 1 and selected == 4) {
	selected = 1
	audio_play_sound(sfx_move, 10, false)
